...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://songshu.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '2246806852de80438057fdc12c3befb5',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '松鼠创客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI超级个体，自媒体人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ai.songshu.blog/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '松鼠创客, 松鼠, 创客, 多模态大模型, 视觉, 目标检测, 智科帮, 松鼠AI', // 网站关键词 英文逗号隔开
